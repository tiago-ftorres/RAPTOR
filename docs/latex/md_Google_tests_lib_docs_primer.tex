\hypertarget{md_Google_tests_lib_docs_primer_autotoc_md226}{}\doxysection{Introduction\+: Why Google\+Test?}\label{md_Google_tests_lib_docs_primer_autotoc_md226}
...
\end{longtabu}
\hypertarget{md_Google_tests_lib_docs_primer_autotoc_md228}{}\doxysection{Basic Concepts}\label{md_Google_tests_lib_docs_primer_autotoc_md228}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_Google_tests_lib_docs_primer_autotoc_md229}{}\doxysection{Assertions}\label{md_Google_tests_lib_docs_primer_autotoc_md229}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \mbox{\hyperlink{md_Google_tests_lib_docs_reference_assertions}{Assertions Reference}}.\hypertarget{md_Google_tests_lib_docs_primer_autotoc_md230}{}\doxysection{Simple Tests}\label{md_Google_tests_lib_docs_primer_autotoc_md230}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_Google_tests_lib_docs_primer_same-data-multiple-tests}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_Google_tests_lib_docs_primer_same-data-multiple-tests}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_Google_tests_lib_docs_primer_autotoc_md231}{}\doxysection{Invoking the Tests}\label{md_Google_tests_lib_docs_primer_autotoc_md231}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_Google_tests_lib_docs_primer_autotoc_md232}{}\doxysection{Writing the main() Function}\label{md_Google_tests_lib_docs_primer_autotoc_md232}
...
But maybe you think that writing all those {\ttfamily main} functions is too much work? We agree with you completely, and that\textquotesingle{}s why Google Test provides a basic implementation of \mbox{\hyperlink{main_8cpp_a0ddf1224851353fc92bfbff6f499fa97}{main()}}. If it fits your needs, then just link your test with the {\ttfamily gtest\+\_\+main} library and you are good to go.

\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_Google_tests_lib_docs_primer_autotoc_md233}{}\doxysection{Known Limitations}\label{md_Google_tests_lib_docs_primer_autotoc_md233}
