You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read \mbox{\hyperlink{md_Google_tests_lib_docs_gmock_for_dummies}{the dummy guide}} first to make sure you understand the basics.

\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md118}{}\doxysection{Creating Mock Classes}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md118}
...
\end{DoxyItemize}\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md119}{}\doxysubsection{Dealing with unprotected commas}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md119}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md120}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md120}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md121}{}\doxysubsection{Mocking Overloaded Methods}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md121}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md122}{}\doxysubsection{Mocking Class Templates}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md122}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_MockingNonVirtualMethods}{}\doxysubsection{Mocking Non-\/virtual Methods}\label{md_Google_tests_lib_docs_gmock_cook_book_MockingNonVirtualMethods}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md123}{}\doxysubsection{Mocking Free Functions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md123}
...
Alternatively, instead of introducing a new interface, you can rewrite your code to accept a std\+::function instead of the free function, and then use \href{\#MockFunction}{\texttt{ Mock\+Function}} to mock the std\+::function.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md124}{}\doxysubsection{Old-\/\+Style $<$tt$>$\+MOCK\+\_\+\+METHODn$<$/tt$>$ Macros}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md124}
...
\end{longtabu}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_NiceStrictNaggy}{}\doxysubsection{The Nice, the Strict, and the Naggy}\label{md_Google_tests_lib_docs_gmock_cook_book_NiceStrictNaggy}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md125}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md125}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_DelegatingToFake}{}\doxysubsection{Delegating Calls to a Fake}\label{md_Google_tests_lib_docs_gmock_cook_book_DelegatingToFake}
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md128}{}\doxysection{Using Matchers}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md128}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md129}{}\doxysubsection{Matching Argument Values Exactly}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md129}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md130}{}\doxysubsection{Using Simple Matchers}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md130}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_CombiningMatchers}{}\doxysubsection{Combining Matchers}\label{md_Google_tests_lib_docs_gmock_cook_book_CombiningMatchers}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_SafeMatcherCast}{}\doxysubsection{Casting Matchers}\label{md_Google_tests_lib_docs_gmock_cook_book_SafeMatcherCast}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_SelectOverload}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_Google_tests_lib_docs_gmock_cook_book_SelectOverload}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md131}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md131}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md132}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md132}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md133}{}\doxysubsection{Using Matchers as Predicates}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md133}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md134}{}\doxysubsection{Using Matchers in googletest Assertions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md134}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md135}{}\doxysubsection{Using Predicates as Matchers}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md135}
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the \mbox{\hyperlink{md_Google_tests_lib_docs_reference_matchers}{Matchers Reference}} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in the statement {\ttfamily if (condition) ...}.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md136}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md136}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily EXPECT\+\_\+\+CALL()}, or the result is undefined.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md137}{}\doxysubsection{Validating a Member of an Object}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md137}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md138}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md138}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_CustomMatcherClass}{}\doxysubsection{Defining a Custom Matcher Class}\label{md_Google_tests_lib_docs_gmock_cook_book_CustomMatcherClass}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md139}{}\doxysubsection{Matching Containers}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md139}
...
\end{DoxyItemize}\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md140}{}\doxysubsection{Sharing Matchers}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md140}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_PureMatchers}{}\doxysubsection{Matchers must have no side-\/effects}\label{md_Google_tests_lib_docs_gmock_cook_book_PureMatchers}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md141}{}\doxysection{Setting Expectations}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md141}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_UseOnCall}{}\doxysubsection{Knowing When to Expect}\label{md_Google_tests_lib_docs_gmock_cook_book_UseOnCall}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md143}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md143}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily EXPECT\+\_\+\+CALL()} statements will be an error.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_uninteresting-vs-unexpected}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md_Google_tests_lib_docs_gmock_cook_book_uninteresting-vs-unexpected}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \href{\#NiceStrictNaggy}{\texttt{ \char`\"{}\+The Nice, the Strict, and the Naggy\char`\"{}}}.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_ParameterlessExpectations}{}\doxysubsection{Ignoring Uninteresting Arguments}\label{md_Google_tests_lib_docs_gmock_cook_book_ParameterlessExpectations}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, g\+Mock will report an error.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_PartialOrder}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_Google_tests_lib_docs_gmock_cook_book_PartialOrder}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md144}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md144}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md145}{}\doxysection{Using Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md145}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md146}{}\doxysubsection{Returning References from Mock Methods}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md146}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md147}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md147}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md148}{}\doxysubsection{Combining Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md148}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_MockingSideEffects}{}\doxysubsection{Mocking Side Effects}\label{md_Google_tests_lib_docs_gmock_cook_book_MockingSideEffects}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md149}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md149}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_Google_tests_lib_docs_reference_mocking_DefaultValue}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_Google_tests_lib_docs_reference_mocking_DefaultValue}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md150}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md150}
...
Note that both {\ttfamily ON\+\_\+\+CALL} and {\ttfamily EXPECT\+\_\+\+CALL} have the same \char`\"{}later statements take precedence\char`\"{} rule, but they don\textquotesingle{}t interact. That is, {\ttfamily EXPECT\+\_\+\+CALL}s have their own precedence order distinct from the {\ttfamily ON\+\_\+\+CALL} precedence order.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_FunctionsAsActions}{}\doxysubsection{Using Functions/\+Methods/\+Functors/\+Lambdas as Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_FunctionsAsActions}
...
\end{DoxyItemize}\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md151}{}\doxysubsection{Using Functions with Extra Info as Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md151}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md152}{}\doxysubsection{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md152}
...
\end{DoxyItemize}\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md153}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md153}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md154}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md154}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_SelectingArgs}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_Google_tests_lib_docs_gmock_cook_book_SelectingArgs}
...
\end{DoxyItemize}\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md155}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md155}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md156}{}\doxysubsection{Sharing Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md156}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md157}{}\doxysubsection{Testing Asynchronous Behavior}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md157}
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md158}{}\doxysection{Misc Recipes on Using g\+Mock}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md158}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md159}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md159}
...
A few actions (e.\+g. {\ttfamily Do\+All}) copy their arguments internally, so they can never work with non-\/copyable objects; you\textquotesingle{}ll have to use functors instead.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_LegacyMoveOnly}{}\doxysubsubsection{Legacy workarounds for move-\/only types}\label{md_Google_tests_lib_docs_gmock_cook_book_LegacyMoveOnly}
...
\DoxyCodeLine{\textcolor{keyword}{class }MockBuzzer : \textcolor{keyword}{public} Buzzer \{}
\DoxyCodeLine{ \textcolor{keyword}{public}:}
\DoxyCodeLine{  MOCK\_METHOD(\textcolor{keywordtype}{bool}, DoShareBuzz, (Buzz* buzz, \mbox{\hyperlink{structTime}{Time}} timestamp));}
\DoxyCodeLine{  \textcolor{keywordtype}{bool} ShareBuzz(std::unique\_ptr<Buzz> buzz, \mbox{\hyperlink{structTime}{Time}} timestamp)\textcolor{keyword}{ override }\{}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md160}{}\doxysubsection{Making the Compilation Faster}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md160}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md161}{}\doxysubsection{Forcing a Verification}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md161}
...
And that\textquotesingle{}s that.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_UsingThreads}{}\doxysubsection{Using g\+Mock and Threads}\label{md_Google_tests_lib_docs_gmock_cook_book_UsingThreads}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md163}{}\doxysubsection{Controlling How Much Information g\+Mock Prints}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md163}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md164}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md164}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md165}{}\doxysubsection{Running Tests in Emacs}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md165}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md166}{}\doxysection{Extending g\+Mock}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md166}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_NewMatchers}{}\doxysubsection{Writing New Matchers Quickly}\label{md_Google_tests_lib_docs_gmock_cook_book_NewMatchers}
...
For convenience, we allow the description string to be empty ({\ttfamily \char`\"{}\char`\"{}}), in which case g\+Mock will use the sequence of words in the matcher name as the description.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md167}{}\doxysubsubsection{Basic Example}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md167}
...
where the descriptions {\ttfamily \char`\"{}is divisible by 7\char`\"{}} and {\ttfamily \char`\"{}not (is divisible by 7)\char`\"{}} are automatically calculated from the matcher name {\ttfamily Is\+Divisible\+By7}.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md168}{}\doxysubsubsection{Adding Custom Failure Messages}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md168}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md169}{}\doxysubsubsection{Using EXPECT\+\_\+ Statements in Matchers}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md169}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md170}{}\doxysubsubsection{$<$tt$>$\+Match\+And\+Explain$<$/tt$>$}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md170}
You should let {\ttfamily Match\+And\+Explain()} print {\itshape any additional information} that can help a user understand the match result. Note that it should explain why the match succeeds in case of a success (unless it\textquotesingle{}s obvious) -\/ this is useful when the matcher is used inside {\ttfamily Not()}. There is no need to print the argument value itself, as g\+Mock already prints it for you.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md171}{}\doxysubsubsection{Argument Types}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md171}
The type of the value being matched ({\ttfamily arg\+\_\+type}) is determined by the context in which you use the matcher and is supplied to you by the compiler, so you don\textquotesingle{}t need to worry about declaring it (nor can you). This allows the matcher to be polymorphic. For example, {\ttfamily Is\+Divisible\+By7()} can be used to match any type where the value of {\ttfamily (arg \% 7) == 0} can be implicitly converted to a {\ttfamily bool}. In the {\ttfamily Bar(\+Is\+Divisible\+By7())} example above, if method {\ttfamily Bar()} takes an {\ttfamily int}, {\ttfamily arg\+\_\+type} will be {\ttfamily int}; if it takes an {\ttfamily unsigned long}, {\ttfamily arg\+\_\+type} will be {\ttfamily unsigned long}; and so on.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md172}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md172}
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener$\ast$} instead of {\ttfamily std\+::ostream$\ast$}.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md174}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md174}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md175}{}\doxysubsection{Legacy Matcher Implementation}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md175}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md176}{}\doxysubsection{Writing New Cardinalities}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md176}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_QuickNewActions}{}\doxysubsection{Writing New Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_QuickNewActions}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily Action} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \mbox{\hyperlink{gmock-actions_8h_source}{gmock-\/actions.\+h}}} for examples.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md177}{}\doxysubsubsection{Legacy macro-\/based Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md177}
...
\end{longtabu}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md178}{}\doxysubsubsection{Legacy macro-\/based parameterized Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md178}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md179}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an ACTION}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md179}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md180}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md180}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md181}{}\doxysubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md181}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_NewMonoActions}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_NewMonoActions}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_NewPolyActions}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_Google_tests_lib_docs_gmock_cook_book_NewPolyActions}
...
\end{DoxyCode}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md182}{}\doxysubsection{Teaching g\+Mock How to Print Your Values}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md182}
...
This printer knows how to print built-\/in C++ types, native arrays, STL containers, and any type that supports the {\ttfamily $<$$<$} operator. For other types, it prints the raw bytes in the value and hopes that you the user can figure it out. \href{advanced.md\#teaching-googletest-how-to-print-your-values}{\texttt{ The Google\+Test advanced guide}} explains how to extend the printer to do a better job at printing your particular type than to dump the bytes.\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md183}{}\doxysection{Useful Mocks Created Using g\+Mock}\label{md_Google_tests_lib_docs_gmock_cook_book_autotoc_md183}
\hypertarget{md_Google_tests_lib_docs_gmock_cook_book_MockFunction}{}\doxysubsection{Mock std\+::function}\label{md_Google_tests_lib_docs_gmock_cook_book_MockFunction}
